    ...
    <header className="bg-[#1E3A8A] text-white sticky top-0 z-30 shadow-md transition-colors border-b border-blue-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#FCD34D] text-[#1E3A8A] rounded-lg flex items-center justify-center font-bold shadow-xs">
            <GraduationCap className="w-6 h-6" />
          </div>
          <div>
            <h1 className="text-xl font-bold tracking-wider leading-tight uppercase">
              Verma Classes
            </h1>
            <p className="text-[10px] text-blue-200 tracking-widest font-semibold uppercase">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-xs font-bold text-white bg-white/10 hover:bg-white/20 rounded-lg transition-all cursor-pointer"
